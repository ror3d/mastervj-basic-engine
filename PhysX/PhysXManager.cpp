...
{
	physx::PxShape* shape = createStatic(name, Material, position, orientation, size);
...
void CPhysXManager::InitPhysx(){
	...
	createBoxTrigger("BoxTrigger", Vect3f(5, 5, 5), "StaticObjectMaterial", Vect3f(5, 2, 5), Quatf(0, 0, 0, 1));
}
