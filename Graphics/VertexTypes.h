...
#define MV_VERTEX_TYPE_BINORMAL				0x160
#define MV_VERTEX_TYPE_TANGENCIAL			0x320
...
#define IFDEF_CREATE_GET_VERTEX_TYPE_1_BINTANG MV_VERTEX_TYPE_BINORMAL | MV_VERTEX_TYPE_TANGENCIAL
...
#define CREATE_MVD3D11_VERTEX(StructName, HasPosition, HasPosition4, HasNormal, HasWeightIndices, HasColor, HasUV, HasUV2, HasBinormalTang) \
struct StructName \
{ \
...
CREATE_MVD3D11_VERTEX(MV_POSITION_WEIGHT_INDICES_NORMAL_TEXTURE_VERTEX, 1, 0, 1, 1, 0, 1, 0, 0);
CREATE_MVD3D11_VERTEX(MV_POSITION_NORMAL_TEXTURE_VERTEX, 1, 0, 1, 0, 0, 1, 0, 0);
CREATE_MVD3D11_VERTEX(MV_POSITION4_COLOR_TEXTURE_VERTEX, 0, 1, 0, 0, 1, 1, 0, 0);
CREATE_MVD3D11_VERTEX(MV_POSITION_COLOR_VERTEX, 1, 0, 0, 0, 1, 0, 0, 0);
CREATE_MVD3D11_VERTEX(MV_POSITION_TEXTURE_VERTEX, 1, 0, 0, 0, 0, 1, 0, 0);
CREATE_MVD3D11_VERTEX(MV_POSITION_COLOR_TEXTURE_VERTEX, 1, 0, 0, 0, 1, 1, 0, 0);
CREATE_MVD3D11_VERTEX(MV_POSITION_NORMAL_TEXTURE_TEXTURE2_VERTEX, 1, 0, 1, 0, 0, 1, 1, 0);
//Falta color_normal_text?
CREATE_MVD3D11_VERTEX(MV_POSITION4_NORMAL_TEXTURE_TEXTURE2_VERTEX, 1, 1, 1, 0, 0, 1, 1, 0);
CREATE_MVD3D11_VERTEX(MV_POSITION4_NORMAL_TEXTURE_VERTEX, 1, 1, 1, 0, 0, 1, 0, 0);
CREATE_MVD3D11_VERTEX(MV_POSITION4_WEIGHT_INDICES_NORMAL_TEXTURE_VERTEX, 1, 1, 1, 1, 0, 1, 0, 0);

CREATE_MVD3D11_VERTEX(MV_POSITION_NORMAL_TEXTURE_BINTANG_VERTEX, 1, 0, 0, 1, 0, 1, 0, 1);
